      ...
      <a.div className="about__container" style={springs[1]}>
        <article className="about__content">
          <p>
            ...
            a Full-stack Software Engineer with a profound expertise in
            developing, architecting, and optimizing digital solutions. My
            capabilities extend beyond conventional full-stack development to
            encompass backend services, cloud computing, automation, and the
            Internet of Things (IoT).
          </p>

          <p>
            With extensive experience in the software development field, I've
            been actively building my technical, leadership, and collaborative
            skills since May 2022 at
        ...
        <div className="about__image">
          <Image src="/brian.png" width={700} height={700} alt="Headshot" />
        </div>
      </a.div>
    </Section>
  );
